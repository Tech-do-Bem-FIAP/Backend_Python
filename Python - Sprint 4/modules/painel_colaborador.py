...
from modules import storage, utils, crud, relatorios
...
def menu_colaborador(colaborador: dict) -> None:
    while True:
        ...
        print("  [0] Logout")
        opcao = utils.input_inteiro("  Opção: ", 0, 7)
